...
try {
    ...
    // FETCH USER
    $stmt = $pdo->prepare("SELECT full_name, contact_email, theme FROM non_students WHERE username = ?");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['theme'])) {
        $theme = $_POST['theme'];
        $stmt = $pdo->prepare("UPDATE non_students SET theme = ? WHERE username = ?");
...
<body class="<?php echo $user['theme']; ?>">
...
<div class="main-content">
    ...
    <main>
        ...
        <section class="settings-section">
            ...
            <p>Email: <?php echo htmlspecialchars($user['contact_email']); ?></p>
        </section>
